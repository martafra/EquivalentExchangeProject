	...
	<body class="bubble-background">
		...
		<div id="headerbar">
			...
			<div id="par1" class="textDiv">
				...
				<% } else { %>
					<div style="width: 100%; height: 300px;" class="substitute"></div>
				<% } %>
				<div id="text1"><%=texts[0] %></div>
			</div>
			<div id="par2" class="textDiv" >
				<% if(imagePaths[1] != null){ %>
					<img src="file?path=<%= imagePaths[1]%>" alt="artImage" onerror="this.src='assets/images/missing.png';"/>
				<% } else { %>
					<div style="width: 100%; height: 300px;" class="substitute"></div>
				<% } %>
			...
			<div id="par3" class="textDiv">
				<% if(imagePaths[2] != null){ %>
					<img src="file?path=<%= imagePaths[2]%>" alt="artImage" onerror="this.src='assets/images/missing.png';"/>
				<% } else { %>
					<div style="width: 100%; height: 300px;" class="substitute"></div>
				<% } %>
			...
			<div id="par4" class="textDiv">
				<% if(imagePaths[3] != null){ %>
					<img src="file?path=<%= imagePaths[3]%>" alt="artImage" onerror="this.src='assets/images/missing.png';"/>
				<% } else { %>
					<div style="width: 100%; height: 300px;" class="substitute"></div>
				<% } %>
